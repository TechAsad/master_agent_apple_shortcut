...
vector_store = PineconeVectorStore(index_name=index_name, embedding=embeddings, namespace= "hormozicourse")
...
def stand_alone(prompt, memory):
    prompt_chat = PromptTemplate(
        ...
        if the chat is empty, simply pass the original question.
